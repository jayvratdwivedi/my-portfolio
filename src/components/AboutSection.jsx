    ...
    >
      ...
      >
        <h3 className="text-sm md:text-2xl font-bold text-purple-200 z-50 lg:max-w-[45rem] max-w-[27rem] tracking-wider md:mt-20 sm:mt-[-40rem] mt-[-32rem]">
          Motivated and detail-oriented Full Stack & DevOps Engineer. Passionate
          about continuously learning and exploring new technologies to enhance
          my skills and stay up-to-date with industry trends. Currently seeking
          opportunities to work with dynamic companies that foster growth and
          creativity.
        </h3>
        <img
          className="lg:h-[40rem] md:h-[25rem] h-[20rem] mix-blend-lighten fade-mask"
